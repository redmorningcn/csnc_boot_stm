...
//    if ( Ctrl.Password != MB_DATA_ACC_PASSWORD ) {
...
//    }
    ...
    CPU_INT16U *preg       = (CPU_INT16U *)& Ctrl;
    /***********************************************
    * 描述： 获取值
    */
                 ...
                 CPU_INT16U   *perr)
{
    ...
    */
    ...
    //CPU_INT16U      *preg       = (CPU_INT16U *) Ctrl.Para.buf2;
    CPU_INT16U *preg       = (CPU_INT16U *)& Ctrl; //首地址
    /***********************************************
    * 描述： 获取值
    */
    if ( reg < sizeof(Unnctrl) / 2 ) {
...
//    CPU_FP32   *preg        = (CPU_FP32 *)&Ctrl.Sen.Para.buf3[0];
    CPU_FP32   *preg        = (CPU_FP32 *)&Ctrl;   //取首地址
...
//    CPU_INT16U *preg       = (CPU_INT16U *)& Ctrl.Para.buf2[0];
    CPU_INT16U *preg       = (CPU_INT16U *)&Ctrl;             //取首地址
